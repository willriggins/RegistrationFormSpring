...
@WebAppConfiguration
@FixMethodOrder(MethodSorters.NAME_ASCENDING) //make it run tests alphabetically
public class RegistrationFormSpringApplicationTests {
	...
	@Before
	public void before() {
		mockMvc = MockMvcBuilders.webAppContextSetup(wac).build(); // sends it to post route?>
	}
	...
	public void aTestAddUser() throws Exception {
		...
		user.setAddress("17A Princess Street");
